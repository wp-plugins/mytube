...
function MyTube_admin_menu() {
	...
	add_submenu_page( __FILE__, 'Global Settings', 'Global Settings', 'manage_options',__FILE__.'_settings', 'MyTube_management_settings' );
	//add_options_page('MyTube Playlist', 'MyTube Playlist', 'manage_options',__FILE__.'_settings', 'MyTube_management_settings' );
	add_submenu_page( '', 'Save Category', 'Save Category', 'manage_options',__FILE__.'_savedata', 'MyTube_save_data' );
